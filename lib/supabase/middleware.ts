...
export async function updateSession(request: NextRequest) {
  ...
  // Only redirect to login if user is not authenticated and not on auth pages
  if (!user && !isAuthPage) {
